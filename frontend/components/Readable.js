...
//데이터의 위치를
export default function Readable({amISend,  nickName,  time,  place,  context,  latitude,  longitude,}) {
  console.log(    'Readable',    amISend,    nickName,    time,    place,    context,    latitude,    longitude,);
